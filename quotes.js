...
const quotes = [
  ...
  {
    quote:" 슬픔이 그대의 삶으로 밀려와마음을 흔들고 소중한 것을 쓸어가 버릴 때면 그대 가슴에 대고 말하라.“이것 또한 지나가리라”",
    author:"– 랜터 윌슨 스미스"
  },
];

const quote =  dc.querySelector("#quote span:first-child");
const author = dc.querySelector("#quote span:last-child")


// cl.log(quotes[0])

const log_Quotes_Random = quotes[Math.floor(Math.random() *quotes.length)]

quote.innerText = log_Quotes_Random.quote;

author.innerText = log_Quotes_Random.author;